...
1. `CF_API_URL`: The URL for accessing the CloudFoundry API in the environment
1. `CF_API_CLIENT_ID`: A UAA client ID used for accessing the CloudFoundry API
1. `CF_API_CLIENT_SECRET`: A UAA client secret used for accessing the CloudFoundry API
