...
cf push "smoke-tests-db-rotate-creds-${SERVICE_PLAN}" -f manifest.yml --var pg-service="rds-smoke-tests-db-rotate-creds-$SERVICE_PLAN" --no-start
...
cf push "smoke-tests-db-rotate-creds-${SERVICE_PLAN}" --var pg-service="rds-smoke-tests-db-rotate-creds-$SERVICE_PLAN"
