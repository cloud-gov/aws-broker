...
cf push "smoke-tests-db-update-storage-${SERVICE_PLAN}" -f manifest.yml --var pg-service="rds-smoke-tests-db-update-storage-$SERVICE_PLAN" --no-start
...
cf push "smoke-tests-db-update-storage-${SERVICE_PLAN}" --var pg-service="rds-smoke-tests-db-update-storage-$SERVICE_PLAN"
