...
// engine.go — per-engine baseline abstraction.
//
...
// sites. Adding Oracle behind this interface keeps engine-specific logic out of
// scattered `if i.DbType==...` conditionals. Adding STIG-hardened
...
// services/rds/baselines/) that a future CSB brokerpak can reuse (see docs/oracle19c/design-notes.md).
//
...
// Edition 2 + License Included. Enterprise Edition (oracle-ee) is NOT
...
type RDSBaseline interface {
	...
	// silently provision with no audit-log posture.
